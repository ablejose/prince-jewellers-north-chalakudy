...
export const BRAND: BrandConfig = {
  ...
  description:
    "Prince Jewellers is Chalakudy's trusted destination for exquisite gold, diamond, and silver jewellery. Serving Chalakudy and the surrounding areas with timeless craftsmanship and contemporary designs for every celebration.",
  ...
  mapsLink:
    "https://www.google.com/maps/search/?api=1&query=Prince%20Jewellers&query_place_id=ChIJiTuW_GoCCDsRrzosIN6MQtI",
  ...
  seo: {
    title: "Prince Jewellers | Jewellery in Chalakudy",
    description:
      "Prince Jewellers — your premier jewellery store in Chalakudy. Gold, diamond and silver jewellery crafted for every occasion. Visit us in Chalakudy, Kerala.",
    keywords: [
      "Prince Jewellers",
      "jewellery Chalakudy",
    ...
    canonical: "https://prince-jewellers-north-chalakudy.vercel.app",
    ogImage:
      "/images/store1.webp",
  },
  ...
  whatsappMessage:
    "Hello Prince Jewellers, I'd like to know more about your jewellery collections.",
};
